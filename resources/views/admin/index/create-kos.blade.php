...
<div class="row mb-5">
    ...
    <form method="POST" action="/dashboard" enctype="multipart/form-data">
        ...
        <div class="mb-3">
            ...
            <input type="text" name="nama" class="form-control @error('nama') is-invalid @enderror" id="nama" value="{{ old('nama') }}" autofocus placeholder="nama kos">
            @error('nama')
        ...
        <div class="mb-3">
            ...
            <input type="text" name="slug" class="form-control @error('slug') is-invalid @enderror" id="slug" value="{{ old('slug') }}" placeholder="nama-kos">
            @error('slug')
                <div class="invalid-feedback">
                    {{ $message }}
                </div>
        ...
        <div class="mb-3">
            ...
            <input type="text" name="alamat" class="form-control @error('alamat') is-invalid @enderror" id="alamat" value="{{ old('alamat') }}" placeholder="alamat lengkap kos">
            @error('alamat')
                <div class="invalid-feedback">
                    {{ $message }}
                </div>
        ...
        <div class="mb-3">
            ...
            <input type="text" name="telepon" class="form-control @error('telepon') is-invalid @enderror" id="telepon" value="{{ old('telepon') }}" placeholder="Nomor Telepon">
            @error('telepon')
                <div class="invalid-feedback">
                    {{ $message }}
                </div>
        ...
        <div class="row d-flex">
            <div class="mb-3 col-3">
                ...
                <input type="number" name="harga" class="form-control @error('harga') is-invalid @enderror" id="harga" min="100000" value="{{ old('harga') }}" placeholder="100000">
                @error('harga')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
            ...
            <div class="mb-3 col-3">
                ...
                <input type="number" name="jarak" class="form-control @error('jarak') is-invalid @enderror" id="jarak" min="0" max="5" value="{{ old('jarak') }}" step="any" placeholder="0.1">
                @error('jarak')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
