...
<form method="POST" action="/dashboard/{{ $kos->slug }}" enctype="multipart/form-data">
<div class="row mb-5">
    <div class="col-lg-8">
    <form method="POST" action="/dashboard/{{ $kos->slug }}">
        ...
        <div class="mb-3">
            ...
            <input type="tel" name="telepon" class="form-control @error('telepon') is-invalid @enderror" id="telepon" value="{{ $kos->telepon, old('telepon') }}">
            @error('telepon')
                <div class="invalid-feedback">
                    {{ $message }}
                </div>
